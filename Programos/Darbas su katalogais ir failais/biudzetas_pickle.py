...
class Biudzetas():
    ...
    def gauti_zurnala(self):
        try:
            with open("zurnalas.pkl", "rb") as pickle_out:
                zurnalas = pickle.load(pickle_out)
        except:
            zurnalas = []
        return zurnalas

    def atnaujinti_zurnala(self):
        try:
            os.remove("zurnalas.pkl")
        except:
            pass
        with open("zurnalas.pkl", "wb") as pickle_in:
            pickle.dump(self.zurnalas, pickle_in)
    ...
    def isvalyti_programos_duomenis(self):
        try:
            os.remove("zurnalas.pkl")
            self.zurnalas = []
            print("Išvalyta!")
        except:
            print("Išvalyti nepavyko")
...
while True:
    ...
    print("9 - Ištrinti visus programos duomenis")
    ...
    if pasirinkimas == "9":
        mano_biudzetas.isvalyti_programos_duomenis()
    if pasirinkimas == "0":
        break